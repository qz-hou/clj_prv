...
other_push_args = ":parent-selection :lexicase :genetic-operator-probabilities {:modified-uniform-addition-and-deletion,1} :add-instruction-from-other-rate 0.75 :uniform-addition-and-deletion-rate 0.09 :print-timings true"
